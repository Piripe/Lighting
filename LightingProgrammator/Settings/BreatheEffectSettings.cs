...
{
    public partial class BreatheEffectSettings : UserControl, ISettingsPanel
    {
        public ILightingEffect Effect { get => effect; }
        private BreatheEffect effect;
        private Timeline timeline;

        public BreatheEffectSettings(BreatheEffect effect, Timeline timeline)
        {
            this.effect = effect;
            ...
            numericUpDown1.Value = effect.BPM;
            numericUpDown2.Value = effect.GradientLength;
        ...
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            if (timeline.mainSelectionEffect == effect)
            {
                SettingsUtils.SetSetting(timeline.effectsSelection, effect, "BPM", (int)numericUpDown1.Value);
                timeline.UpdateDisplay();
            }
        }
        ...
        private void numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            if (timeline.mainSelectionEffect == effect)
            {
                SettingsUtils.SetSetting(timeline.effectsSelection, effect, "GradientLength", (int)numericUpDown2.Value);
                timeline.UpdateDisplay();
            }
        }
